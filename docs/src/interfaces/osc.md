...
[player configuration](../getting-started/player-config.md) for the exact name of these events.
...
the playlist. Again, refer to the [player configuration](../getting-started/player-config.md)
