...
pub fn all() -> Vec<Check> {
    vec![
        entry!("devices", "advertised_devices_are_openable",
        ...
        entry!("devices", "selected_output_is_real_hardware",
        ...
        entry!("midi-config", "midi_beat_clock_persists",
